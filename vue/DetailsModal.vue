...
.dm-overlay {
  ...
  --_text-2xl: var(--font-size-2xl, 1.5rem);
  /* Shape */
...
.dm-header { position: sticky; top: 0; background-color: var(--_white); border-bottom: 2px solid var(--_black); padding: var(--_space-6); display: flex; justify-content: space-between; align-items: flex-start; }
.dm-title { font-size: var(--_text-2xl); font-weight: 700; text-transform: uppercase; letter-spacing: 0.025em; }
.dm-close-btn { color: var(--_black); flex-shrink: 0; margin-left: var(--_space-4); padding: var(--_space-1); background: none; border: none; cursor: pointer; transition: color 150ms ease; }
.dm-close-btn:hover { color: var(--_primary); }
.dm-content { padding: var(--_space-6); }
.dm-important-box { background-color: var(--_warning-bg); border: 1px solid var(--_warning-border); padding: var(--_space-3); margin-bottom: var(--_space-6); border-radius: var(--_radius); }
.dm-important-text { font-size: var(--_text-sm); font-weight: 700; color: var(--_warning-text); }
.dm-section { margin-bottom: var(--_space-6); }
.dm-section:last-child { margin-bottom: 0; }
.dm-section-title { font-weight: 700; text-transform: uppercase; font-size: var(--_text-lg); margin-bottom: var(--_space-2); }
.dm-section-text { font-size: var(--_text-sm); line-height: 1.6; }
.dm-section-text-secondary { font-size: var(--_text-sm); line-height: 1.6; margin-top: var(--_space-2); color: var(--_gray-600); }
.dm-link { text-decoration: underline; transition: color 150ms ease; color: inherit; }
.dm-link:hover { color: var(--_primary); }
.dm-footer { position: sticky; bottom: 0; background-color: var(--_white); border-top: 2px solid var(--_black); padding: var(--_space-6); }
.dm-footer-btn { background-color: var(--_primary); color: var(--_white); padding: var(--_space-3) var(--_space-8); font-weight: 700; text-transform: uppercase; border: none; cursor: pointer; transition: background-color 150ms ease; }
